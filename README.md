...
- Comprueba las credenciales en `php/config/database.php`
- Asegúrate de que la base de datos `biblioteca` existe
...
- Solo se pueden eliminar usuarios sin préstamos activos
- El usuario no debe tener libros prestados a otros
- No se puede eliminar el administrador principal

## 📝 Notas para Estudiantes

### Código en Español
Todo el código está comentado en español para facilitar la comprensión:
- Variables con nombres descriptivos
- Comentarios explicativos en cada función
- Estructura clara y organizada

### Fácil de Modificar
- Código modular separado por funcionalidades
